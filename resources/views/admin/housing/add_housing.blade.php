        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Add</h4>  <br>  
                    <form method="POST" action="{{ route('store.housing')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="house_type" class="form-control" type="text">
                                @error('house_type')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="house_options" class="form-control" type="text" value="no option" data-role="tagsinput">
                                @error('house_options')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror   
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="rent_price"> 
                                @error('rent_price')
                                    <span class="text-danger"> {{ $message }}</span>
                                @enderror                              
                            </div>
