                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('store.profile') }} " enctype="multipart/form-data">
                        ...
                        <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                            ...
                            <div class="col-sm-10">
                                <img id="showImage" class="w-25 img-fluid rounded avatar-lg" src="{{
                            (!empty($editData->profile_image))? url('upload/admin_images/'.$editData->profile_image): url('upload/no-image.jpg') }}" alt="image">
                            </div>
                        </div>
                        <!-- end row -->
