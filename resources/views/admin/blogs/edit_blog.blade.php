                ...
                <style type="text/css">
                    ...
                    <form method="POST" action="{{ route('update.blog', $edit_blogs->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="title" class="form-control" type="text" value="{{ $edit_blogs->title }}" id="short_title">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImage" class="w-25 rounded avatar-lg" src="{{ asset ($edit_blogs->image) }}" alt="image">
                            </div>
                        </div>
                        <!-- end row -->
