        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('store.cargo') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="cargo_type" class="form-control" type="text" value="">
                                @error('cargo_type')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="date_to_be_send" class="form-control" type="date">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="from_location" class="form-control" type="text">                            
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="to_location" class="form-control" type="text">                            
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="cargo_description" id="elm1"> </textarea>  
                        ...
                        <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="delivery_fee"> 
                                @error('delivery_fee')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror                              
                            </div>
                        ...
                        <!-- submit button -->
                        <input type="submit" class="btn btn-info waves-effect waves-light" value="Add Cargo">
